...
| [Phase 3: Domain Model, Seed Data, and Deterministic Engine](phases/phase-03-domain-model-seed-data-and-deterministic-engine/phase.md) | `developer -> tester` | `unit-regression`, `build-health` | Phase 2: Stack and Project Foundation | `blocked` |
