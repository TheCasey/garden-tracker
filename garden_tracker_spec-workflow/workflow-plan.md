...
| [Phase 6: Dashboard Plant Matrix and Container Zone](phases/phase-06-dashboard-plant-matrix-and-container-zone/phase.md) | `developer -> tester` | `browser-smoke`, `interaction-smoke`, `unit-regression` | Phase 5: Design System and App Shell UI | `ready_for_master_developer` |
