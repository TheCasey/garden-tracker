...
| [Phase 4: Local Persistence and Repository Contract](phases/phase-04-local-persistence-and-repository-contract/phase.md) | `developer -> tester` | `unit-regression`, `build-health` | Phase 3: Domain Model, Seed Data, and Deterministic Engine | `blocked` |
